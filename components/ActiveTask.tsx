        ...
        return (
            <div className={'w-full h-full grid grid-cols-9 grid-rows-3 gap-2'}>
                <div className={'col-start-1 col-end-8'}>
                    {data!=undefined?<p className={'w-full font-semibold text-lg'}>{data.userGetState.currentJob.title}</p>:null}
                </div>
                <div className={'col-start-8 col-end-10 bg-black rounded-full flex justify-center items-center'}>
                    <p className={'text-white inline-block font-semibold'}>+{data.userGetState.currentJob.carrotsForApproxMeters}</p>
                ...
                <div className={'row-start-2 col-start-1 col-end-10 '+h_bar} style={styles}>
                    ...
                    <ProgressBar progress={data.userGetState.currentJobStepsProgress.metersPassed} limit={data.userGetState.currentJob.approxMeters}/>
                </div>
                ...
                <div className={'col-start-1 col-end-8 row-start-3 flex items-end'}>
                    <p className={'w-full font-semibold text-xs text-[#898994]'}>Progress: <strong>{data.userGetState.currentJobStepsProgress.metersPassed}/{data.userGetState.currentJob.approxMeters} km</strong>
                    </p>
                </div>
