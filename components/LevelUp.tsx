...
const LevelUp = ({bunny, togglePop,skillpoints}: LevelUpInterface) => {
    ...
    return (
        <div
            className={'fixed z-[999] w-full h-full top-0 left-0 grey-gradient justify-center items-center overflow-y-scroll flex flex-wrap justify-around'}>
            <div
            ...
            <button className={'w-72 rounded-full text-black font-bold text-3xl h-20 green-gradient'}>Confirm</button>
        </div>
    );
};
